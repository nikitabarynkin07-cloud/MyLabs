...
namespace ConsoleApp2
{
    class Program
    {
        ...
        /// <returns></returns>
        static int distance(string message)
        {
        ...
        {
            Console.WriteLine("Введите цену топливу за литр:");
            double price;
        ...
        static void CalculateTrip()
        {
            ...
            //Ввод данных
            int Distance = distance("Введите расстояние (в км)");
            ...
            double RateType = CalculateRate(Rate, transportType);

            //Подсчет финального расхода ( с учетом сезона)
            double finalRate = SeasonCoff(RateType, seasonType);
            ...
            SaveTripHistory(Distance, transportName, seasonName, totalCost);
        ...
        /// <param name="TransportType"></param>
        /// <returns></returns>
        static double CalculateRate(double rate, int TransportType)
        {
            double trc;
            switch (TransportType)
            {
        ...
        /// <param name="SeasonType"></param>
        /// <returns></returns>
        static double SeasonCoff(double rate, int SeasonType)
        {
            double trc;
            switch (SeasonType)
            {
        ...
        static void PrintResult(int distance, double rate, double price, string transportName, string seasonName, double TotalCost)
        {
            Console.WriteLine("\n=== Результаты расчета ===");
        ...
        /// <param name="seasonName"></param>
        /// <param name="TotalCost"></param>
        static void SaveTripHistory(int distance, string transportName, string seasonName, double TotalCost)
        {
            if (Count >= 10)
            {
                for (int i = 0; i< 9 ; i++)
